...
const ContactSectionGlassmorphism = () => {
  ...
  // 🔄 Now uses your Node API instead of EmailJS
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetch("https://bluelife.llc/api/contact/contact", {
        method: "POST",
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div
          className="absolute -top-40 -right-40 w-80 h-80 rounded-full blur-3xl animate-pulse backdrop-blur-xl"
          style={{
        ...
        ></div>
        <div
          className="absolute -bottom-40 -left-40 w-96 h-96 rounded-full blur-3xl animate-pulse delay-1000 backdrop-blur-xl"
          style={{
        ...
        ></div>
        <div
          className="absolute top-1/4 left-1/4 w-32 h-32 rounded-full animate-bounce backdrop-blur-xl"
          style={{
        ...
        ></div>
        <div
          className="absolute bottom-1/4 right-1/4 w-24 h-24 rounded-full animate-pulse delay-700 backdrop-blur-xl"
          style={{
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-10 pt-20 pb-16 relative z-10">
        ...
        <div className="text-center mb-16">
          <div
            className="inline-flex items-center gap-3 px-6 py-3 rounded-2xl mb-8 backdrop-blur-xl transition-all duration-300 hover:scale-105"
            style={{
          ...
          <p
            ...
            style={{ color: "#475569" }}
          >
            Connect with our expert advisors for personalized financial
            solutions that secure your future.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-8 items-start">
          ...
          <div className="space-y-6">
            {/* Main Contact Card */}
            <div
              className="rounded-3xl p-8 relative overflow-hidden backdrop-blur-2xl border transition-all duration-300 hover:shadow-2xl"
              style={{
                background:
                  "linear-gradient(135deg, rgba(255, 255, 255, 0.7) 0%, rgba(255, 255, 255, 0.4) 100%)",
                borderColor: "rgba(0, 176, 255, 0.3)",
                boxShadow:
                  "0 8px 32px rgba(0, 176, 255, 0.15), inset 0 1px 0 rgba(255, 255, 255, 0.8), 0 0 0 1px rgba(255, 255, 255, 0.5)",
              }}
            >
              {/* Gradient Accent */}
              ...
              <div className="flex items-center gap-4 mb-8">
                <div
                  className="w-16 h-16 rounded-2xl flex items-center justify-center backdrop-blur-xl border transition-all duration-300 hover:scale-110"
                  style={{
                    background: "rgba(255, 255, 255, 0.6)",
                    borderColor: `rgba(0, 176, 255, 0.3)`,
                    boxShadow:
                      "0 4px 16px rgba(0, 176, 255, 0.2), inset 0 1px 0 rgba(255, 255, 255, 0.8)",
                  }}
                >
                  <Award
                    className="w-8 h-8"
              ...
              <div className="space-y-4 mb-8">
                <div
                  className="flex items-center gap-4 p-4 rounded-xl backdrop-blur-xl border transition-all duration-300 hover:scale-[1.02] hover:shadow-lg"
                  style={{
                    background: "rgba(255, 255, 255, 0.5)",
                    borderColor: `rgba(0, 176, 255, 0.2)`,
                    boxShadow:
                      "0 4px 16px rgba(0, 176, 255, 0.1), inset 0 1px 0 rgba(255, 255, 255, 0.8)",
                  }}
                >
                  <div
                  ...
                  <div>
                    ...
                    >
                      Mon-Fri: 6pm-9pm | Weekends: By appointment
                    </div>
                  </div>
                </div>
              ...
              <div className="space-y-4">
                <a
                  ...
                  style={{
                    ...
                    color: "#ffffff",
                    boxShadow:
                      "0 8px 24px rgba(0, 176, 255, 0.3), inset 0 1px 0 rgba(255, 255, 255, 0.2)",
                  }}
                >
            ...
            <div className="grid grid-cols-3 gap-4">
              {[
                ...
                <div
                  key={index}
                  className="text-center p-4 rounded-2xl backdrop-blur-xl border transition-all duration-300 hover:scale-105 hover:shadow-lg"
                  style={{
                    background: "rgba(255, 255, 255, 0.6)",
                    borderColor: `rgba(0, 176, 255, 0.3)`,
                    boxShadow:
            ...
            <form onSubmit={handleSubmit} className="space-y-6" noValidate>
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full p-4 rounded-xl outline-none transition-all duration-200 backdrop-blur-xl border ${
                    errors.name
              ...
              <div>
                ...
                <textarea
                  ...
                  rows="5"
                  className={`w-full p-4 rounded-xl outline-none resize-none transition-all duration-200 backdrop-blur-xl border ${
                    errors.message
                      ? "border-2 border-red-500 bg-red-50"
                      : "border border-[rgba(0, 176, 255, 0.3)] bg-white/60 focus:border-[#00B0FF] focus:bg-white/80 focus:shadow-lg"
                  }`}
              ...
              <button
                ...
                className={`group w-full py-4 rounded-xl font-semibold transition-all duration-300 transform hover:-translate-y-1 backdrop-blur-sm ${
                  isSubmitting
        ...
        <div className="mt-16 text-center">
          <div
            className="mt-12 pt-8 border-t backdrop-blur-xl rounded-2xl p-6"
            style={{
              borderColor: "rgba(0, 176, 255, 0.3)",
          ...
          >
            ...
            <p className="mb-4" style={{ color: "#64748b" }}>
              Financial Security • Investment Growth • Retirement Planning
            </p>
            <div className="text-sm" style={{ color: "#64748b" }}>
              © {new Date().getFullYear()} BlueLife Financial Solutions LLC. All
              Rights Reserved.
            </div>
          </div>
        </div>
